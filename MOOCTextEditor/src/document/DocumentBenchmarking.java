				...
				numToCheck += increment)
		{
			...
			String text = getStringFromFile(textfile, numToCheck);
				...
				for(int i = 0; i<trials; i++){
					BasicDocument test_1 = new BasicDocument(text);
					test_1.getFleschScore();
				}
				long endTime_1 = System.nanoTime();
				double estTime_1 = (endTime_1 - startTime_1)/1000000000.0;
				
				
				
				long startTime_2 = System.nanoTime();
				for(int i = 0; i<trials; i++){
					EfficientDocument test_2 = new EfficientDocument(text);
					test_2.getFleschScore();
				}
				long endTime_2 = System.nanoTime();
				double estTime_2 = (endTime_2 - startTime_2)/1000000000.0;
				
				System.out.println(numToCheck+"\t "+estTime_1+"\t "+estTime_2);
			}
